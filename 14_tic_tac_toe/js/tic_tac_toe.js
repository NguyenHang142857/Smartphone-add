...
//メッセージ
const msgtxt1 = '<p class = "image"><img src = "img/penguins.jpg" width=61px heigh = 61px></p><p class="text">Penguins Attack!</p>';
const msgtxt2 = '<p class = "image"><img src = "img/whitebear.jpg" width=61px heigh = 61px></p><p class="text">WhiteBear Attack!</p>';
...
newgamebtn.addEventListener("click", function(){
    ...
    counter = 9;
    winningLine = null;
    let music = new Audio(gameSound[5]);
    music.currentTime = 0;
    music.play();
    squaresArray.forEach(function (square){
