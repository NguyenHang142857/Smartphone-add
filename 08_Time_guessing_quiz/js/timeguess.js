...
const stop = document.getElementById("stop");//sua lai thanh chu thuong
...
start.addEventListener("click",
  function() {
    ...
    soundControl("start","sound/star.mp3");
    soundEndflag = "1";
    // ボタンをタイマー"動作中"状態とする
...
stop.addEventListener("click",
  function() {
    // タイマーを"停止中"状態とする
    setButtonStateStopped();//sua lai co khoach
    ...
    document.body.style.backgroundImage = "url('img/fireworks.gif')";//them vao ngay 10/09
